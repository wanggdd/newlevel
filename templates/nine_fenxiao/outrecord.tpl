                                            ...
                                            <div class="item-con">
                                                ...
                                                <div class="right-btn-area pull-right">
                                                    ...
                                                    <div type="button" class="btn btn-outline-danger"><i class="evicon evicon-leading-in-1"></i>
                                                        <a href="/NineFenXiao/exportout.php?user_user_id=<{$user_user_id}>&start_date=<{$start_date}>&end_date=<{$end_date}>&search_mix=<{$search_mix}>"><span>导出数据</span></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <table class="table table-no-outer-border table-spacing-lg">
                                        ...
                                        <{if $record_list}>
                                            ...
                                            <tr class="text-center vertical-middle">
                                                ...
                                                <td><{$item.enter_member}></td>
                                                <td>
                                                    <{$item.enter_time}>

                                                </td>
                                                <td>
                                                    <img src="<{$item.payment_code}>" width="150px" height="150px">
                                                </td>
                                                <td>
